...
export const criticalQuestionsSchema = z.object({
  ...
  questions: z
    .array(z.string())
    .describe(
      "1–4 sharp, specific questions. Each question is exactly 2 sentences. Only generate as many as genuinely needed — if 1 question covers the gap, don't pad with filler. Empty if domain is mixed."
    ),
